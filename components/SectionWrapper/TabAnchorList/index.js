...
import {
    ...
    navigation_buuble, bubble, bubble_active
} from './tablist.module.css'

const TabAnchorList = forwardRef(({ activeKey, onSelect, children }, ref) => {
    return (
        <nav className={`${nav} wrapper_margin_globals`} ref={ref}>
